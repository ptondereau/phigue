...
final readonly class Psr6ShapeCache implements ShapeCache
{
    ...
    public function shape(string $target): Shape
    {
        try {
            ...
            $this->logger->warning('Phigue could not read the cached reflection plan; falling back to reflection.', [
                'target' => $target,
                'exception' => $e,
            ]);
        ...
        try {
            ...
            $this->logger->warning('Phigue could not write the reflection plan to the cache; it will be recomputed next time.', [
                'target' => $target,
                'exception' => $e,
            ]);
